...
export function findOrdinalBetween (ordinalA, ordinalB) {
  ...
  else if (ordinalA === ordinalB) throw newError('can not find an ordinal between equal ordinals', 599, { ordinalA, ordinalB })
  ...
  throw newError('finished without finding an ordinal', 599, { ordinalA, ordinalB, ordinal })
}
