...
export default Marionette.LayoutView.extend({
  ...
  initialize() {
    ...
    if (this.isbnsBatch != null) { this.hideImporters = true;
  ...
  getFile(e){
    ...
    .spread(function(data){
      ...
      return parse(data).map(commonParser);}).catch(_.ErrorRethrow('parsing error'))
  ...
  findIsbns() {
    ...
    .then(addedCandidates=> {
      ...
      if (addedCandidates.length > 0) { return this.showImportQueueUnlessEmpty();
