...
import EntityDataOverview from '#entities/views/entity_data_overview'
import ItemShelves from '../item_shelves.js'
import { listingsData, transactionsData, getSelectorData } from '#inventory/lib/item_creation'
import { getShelvesByOwner } from '#shelves/lib/shelves'
import Shelves from '#shelves/collections/shelves'
import forms_ from '#general/lib/forms'
import error_ from '#lib/error'
import ItemRow from '#inventory/views/item_row'
import itemCreationTemplate from './templates/item_creation.hbs'
import '#inventory/scss/item_creation_commons.scss'
import '#inventory/scss/item_creation.scss'
