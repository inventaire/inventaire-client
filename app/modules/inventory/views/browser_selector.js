...
export default Marionette.LayoutView.extend({
  ...
  toggleOptions(e){
    ...
    if (this.$el.hasClass('showOptions')) { this.hideOptions();
  ...
  filterOptions(intersectionWorkUris){
    if ((intersectionWorkUris == null)) { this.collectionsAction('removeFilter', 'intersection');
    // Do not re-filter if this selector already has a selected option
    } else if (this._selectedOption != null) { return;
    } else {
