<script lang="ts">
  ...
  import { mainUserHasDataadminAccess, mainUserHasWikidataOauthTokens } from '#user/lib/main_user'
  ...
  const hasUserAccess = mainUserHasDataadminAccess() || mainUserHasWikidataOauthTokens()
