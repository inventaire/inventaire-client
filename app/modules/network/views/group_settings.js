...
import { ui as groupUrlUi, events as groupUrlEvents, LazyUpdateUrl } from '../lib/group_url';
...
export default Marionette.ItemView.extend({
  ...
  destroyGroup() {
    ...
    .then(function() {
      ...
      return app.execute('show:inventory:network');}).catch(_.ErrorRethrow('destroyGroup action err'));
