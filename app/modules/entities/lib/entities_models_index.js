...
var getRemoteEntitiesModels = function(uris, refresh, defaultType){
  ...
  .then(function(res){
    ...
    return newEntities;}).catch(_.ErrorRethrow('get entities data err'));
};
...
let _addModel = addModel = function(entityModel){
...
const invalidateGraph = function(uri){
  if (entitiesModelsIndexedByUri[uri] != null) { return entitiesModelsIndexedByUri[uri].graphChanged = true;
