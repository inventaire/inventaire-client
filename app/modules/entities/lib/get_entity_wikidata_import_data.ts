...
import { getPropertyDatatype } from '#app/modules/entities/lib/editor/properties_per_type'
import { getEntitiesByUris, type SerializedEntity } from '#app/modules/entities/lib/entities'
