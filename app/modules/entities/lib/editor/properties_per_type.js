...
export function getTypePropertiesPerCategory (entity) {
  ...
  if (type === 'work') {
    ...
    entityPropertiesPerTypeAndCategory.general = getReshapedGeneralProperties(entity, entityPropertiesPerTypeAndCategory.general)
...
function getReshapedGeneralProperties (entity, generalProperties) {
  return Object.fromEntries(Object.entries(generalProperties).flatMap(([ property, propertySettings ]) => {
    if (property === 'wdt:P50') {
