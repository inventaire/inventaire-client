...
describe('location utils', function() {
  ...
  describe('parseQuery', function() {
    ...
    it("should forgive and forget the '?' before queries", function(done){
    ...
    it('should decode encoded strings', function(done){
    ...
    return it('should parse and decode encoded JSON strings', function(done){
  ...
  return describe('buildPath', function() {
